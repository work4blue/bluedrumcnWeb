...
.project ul.project_details li div {
	font:14px/28px Verdana, Geneva, 'DejaVu Sans', sans-serif;
	font-weight:normal;
	font-style:normal;
}
...
#navigation > li > a {
	font:14px/14px Verdana, Geneva, 'DejaVu Sans', sans-serif;
	font-weight:normal;
	font-style:normal;
}

#navigation ul li a {
	font:14px/16px 'Oxygen', Arial, Helvetica, 'Nimbus Sans L', sans-serif;
	font-weight:normal;
	font-style:normal;
}
...
h1 a,
.logo .title {
	font:36px/50px Arial, Helvetica, 'Nimbus Sans L', sans-serif;
	font-weight:400;
	font-style:normal;
}
...
.error h2, 
#reply-title {
	font:28px/36px Verdana, Geneva, 'DejaVu Sans', sans-serif;
	font-weight:200;
	font-style:normal;
}
...
h3,
h3 a {
	font:22px/36px Verdana, Geneva, 'DejaVu Sans', sans-serif;
	font-weight:300;
	font-style:normal;
}
...
h4 a, 
h1.widgettitle {
	font:20px/36px Verdana, Geneva, 'DejaVu Sans', sans-serif;
	font-weight:300;
	font-style:normal;
}
...
.cmsms_sitemap > li ul > li > a {
	font:16px/60px Verdana, Geneva, 'DejaVu Sans', sans-serif;
	font-weight:600;
	font-style:normal;
}
...
.post.format-aside h6.entry-content {
	font:16px/24px Verdana, Geneva, 'DejaVu Sans', sans-serif;
	font-weight:normal;
	font-style:normal;
}
...
span.dropcap {
	font:24px/48px Verdana, Geneva, 'DejaVu Sans', sans-serif;
	font-weight:bold;
	font-style:normal;
}
...
.social_icons li:nth-child(1):hover {background-color:#dd0000;}
.social_icons li:nth-child(2):hover {background-color:#a0c400;}
.social_icons li:nth-child(3):hover {background-color:#238bdb;}
.social_icons li:nth-child(4):hover {background-color:#ffba19;}
